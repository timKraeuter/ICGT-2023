...
Thus, a modeler does not need to be aware of the \gls*{gt} semantics used for execution.

However, a modeler still needs to know the used temporal logic such as LTL and CTL.
A domain-specific property language for BPMN would further lessen the knowledge required by a modeler \cite{meyersProMoBoxFrameworkGenerating2014}. 
