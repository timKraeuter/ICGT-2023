...
All the rule generation templates can be found in \cite{krauterArtifactsICGT2023}.
...
The atomic property \textsf{Unsafe} is true if two tokens of one process snapshot point to the same sequence flow. This atomic proposition \textit{Unsafe} is depicted in \cref{fig:unsafe}; Groove rules for all the atomic propositions are included in \cite{krauterArtifactsICGT2023}.
