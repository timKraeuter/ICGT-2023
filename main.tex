...
Using our approach, model checking a \gls*{bpmn} model is possible using the generated \gls*{gt} system and a set of behavioral properties with atomic propositions (see \autoref{fig:approach}).
