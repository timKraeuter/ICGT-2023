...
Using our approach, model checking a \gls*{bpmn} model is possible using the generated \gls*{gt} system and a set of temporal properties with atomic propositions (see \autoref{fig:approach}).
...
We cover most \gls*{bpmn} elements when compared to other approaches.
