...
We colored both artifacts blue to visualize that they contain the same information.
...
Furthermore, we consider allowing the modeler to define a start graph like how he can define atomic propositions for custom properties (see \autoref{subsec:customProperties}).
...
To give an intuition about the transformation, we will first describe two example results, meaning generated rules for an NSE and a task (see \autoref{fig:bpmnfeaturesOverview}).
