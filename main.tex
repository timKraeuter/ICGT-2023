...
The \textsf{FlowNode} is colored purple in \autoref{fig:bpmnMetamodel} since it represents the state-changing elements of \gls*{bpmn}, as described in \autoref{sec:formalization}.
